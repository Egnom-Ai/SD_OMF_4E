...
struct AnalysisModel {
    ...
    mutating func panel_zone_yielding_strength(plasticPanelZoneDeformationsIncluded: Bool, Puc_1: Double, Fyc: Double, dc: Double, tcw: Double, bcf: Double, tcf: Double, db: Double, Ac: Double, strain_hardening_Pz: Double = 1.1, Ry: Double = 1.1, alpha: Double = 1.0) -> Double {
    ...
    mutating func designValuesForTheSelectedBolts(boltsType: String) -> (Fnt: Double, Fnv: Double, phiBolt: Double)? {
    ...
    mutating func minimumWeldSizeVerification(tbw: Double, tpSelected: Double, dWShearSelected: Double) -> Double {
    ...
    mutating func maximumWeldSizeVerification(tbw: Double, tpSelected: Double, dWShearSelected: Double) {
...
//    }
    ...
    mutating func connectionDesign () {
